...
namespace UnitTest_SqLite_Net451
{
    ...
    public class UnitAsyncTest
    {
        ...
        public void TestD_Delete1()
        {
            ...
            var result = DbHelp.ExecuteSqlAsync("delete from employee where Id > @startId", p, SugarCommandType.Text).Result;
        ...
        {
            //存储过程，根据存储名称调用存储过程
            var result = DbHelp.ExecuteSqlAsync("delete from employee where Id > @startId", new { startId = 6 }, SugarCommandType.Text).Result;
